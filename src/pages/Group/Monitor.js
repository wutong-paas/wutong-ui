...
import {
  ...
  import AreaChart from '../../pages/Monitor/AreaChart'
  import styles from '../../pages/Monitor/index.less'
  import cookie from '../../utils/cookie'
  
  import CPUQuotaColumns from '../../pages/Monitor/columns/CPUQuotaColumns'
  import memoryQuotaColumns from '../../pages/Monitor/columns/memoryQuotaColumns'
  import networkQuotaColumns from '../../pages/Monitor/columns/networkQuotaColumns'
  
  import configOfCPUUsage from '../../pages/Monitor/config/configOfCPUUsage'
  import configOfMemoryUsage from '../../pages/Monitor/config/configOfMemoryUsage'
  ...
  export default class Monitor extends PureComponent {
    ...
    getSpecialItemData = (itemType) => {
      const { dispatch, teamName, regionName, groupId } = this.props
